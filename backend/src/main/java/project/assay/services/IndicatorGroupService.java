...
public class IndicatorGroupService {
    ...
    public List<IndicatorGroupResponseDTO> findAllWithResponse() {
        return this.findAll();
    }
    ...
    @Transactional
    public IndicatorGroupResponseDTO save(IndicatorGroupRequestDTO dto) {
        IndicatorGroup entity = repository.save(convertToEntity(dto));
        return convertToResponse(entity);
    }

    @Transactional
    public IndicatorGroupResponseDTO update(int id, IndicatorGroupRequestDTO dto) {
        this.findById(id);
        IndicatorGroup newEntity = this.convertToEntity(dto);
        newEntity.setId(id);
        return convertToResponse(repository.save(newEntity));
    }
