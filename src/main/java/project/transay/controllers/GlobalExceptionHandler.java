...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleInvalidFormatException(InvalidFormatException e) {
        ...
        if (errorField.equals("dateOfBirth")) {
            errorMessage = errorField + ": Недопустимый формат даты. Пожалуйста используйте 'dd.MM.yyyy'";
        } else if (errorField.equals("condition")) {
            errorMessage = errorField + ": Недопустимый формат condition. Пожалуйста используйте 'BASE'/'GRAVID'/'MENSES'";
        } else {
